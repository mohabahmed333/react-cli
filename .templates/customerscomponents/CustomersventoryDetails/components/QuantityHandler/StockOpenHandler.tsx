...
Customersterface StockOpenHandlerProps {
    currentStock: number;
...
export default function StockOpenHandler({
  ...
  return (
    <div 
      className={cn(
        "bg-gray-50 p-4 rounded-md w-full transition-all ease-Customers-out overflow-hidden",
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <X className="w-5 h-5 cursor-poCustomerster transition-all ease-Customers-out" style={{ transitionDuration: `${animationDuration}ms` }} />
          </Button>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 w-full">
        ...
        <div className="flex-1 flex flex-col items-start gap-2">
          ...
          <Customersput
            className="h-10 bg-background focus:border-primary focus:rCustomersg-primary"
            placeholder="Ex. 00"
            value={newStock}
            onChange={(e) => {
